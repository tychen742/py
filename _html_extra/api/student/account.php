...
<body>
  <main class="shell">
    <header class="topbar">
      <div>
        <h1>Account</h1>
        <p>Signed in as <?php echo py_h($displayName); ?></p>
      </div>
      <nav>
    ...
    <section class="card">
      <dl>
        <div>
          <dt>Name</dt>
          <dd><?php echo py_h($displayName); ?></dd>
        </div>
        <div>
          <dt>University ID</dt>
          <dd><?php echo py_h($student['student_identifier']); ?></dd>
        </div>
        <div>
          <dt>Email</dt>
          <dd><?php echo py_h($student['email']); ?></dd>
        </div>
      </dl>
