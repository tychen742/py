...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        py_update_assignment_answer_lock($pdo, $assignmentId, $answersUnlocked, (int) $admin['id']);
...
$rows = py_list_assignment_settings($pdo);
?>
<!doctype html>
<html lang="en">
<head>
...
<body>
  <?php echo py_admin_nav('assignments'); ?>
  <main class="shell">
    <header class="topbar">
      <div>
    ...
    <div class="table-wrap">
      <table>
        ...
        <?php foreach ($rows as $row): ?>
          ...
          <tr>
            <td data-sort-value="<?php echo py_h($row['assignment_id']); ?>"><?php echo py_h($row['assignment_id']); ?></td>
            <td data-sort-value="<?php echo py_h($row['chapter']); ?>"><?php echo py_h($row['chapter']); ?></td>
            <td data-sort-value="<?php echo py_h($row['assignment_slug']); ?>"><?php echo py_h($row['assignment_slug']); ?></td>
            ...
            <td data-sort-value="<?php echo py_h($row['updated_at'] ?? ''); ?>"><?php echo py_h($row['updated_at'] ?? ''); ?></td>
            <td>
              <form method="post">
                <input type="hidden" name="assignment_id" value="<?php echo py_h($row['assignment_id']); ?>">
