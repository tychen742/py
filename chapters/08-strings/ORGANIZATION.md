...
2. `0801-strings.ipynb` — string orientation, creation/access, methods, comparison, looping/sorting, and word-list application
3. `0802-regex.ipynb` — regex orientation, the `re` module, syntax, advanced features, and applications
4. `0803-text-analysis.ipynb` — text-analysis orientation, cleaning and normalizing, word frequencies, random text, and Markov generation
