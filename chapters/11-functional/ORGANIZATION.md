# Chapter 11 Organization (Functional Programming)
...
- `1100-intro-func-prog.ipynb`: Chapter intro — learning goals and chapter map; pure functions/immutability framing. No exercises.
- `1101-func-prog.ipynb`: Conceptual foundations — decorators; comprehensions; lambda/map/filter; decision guide for choosing comprehension vs map/filter; functional pipeline readability checks.
- `1102-func-practice.ipynb`: Practice notebook — recursion; context managers; `functools.reduce`, `functools.partial`, `functools.lru_cache`.
...
Use `chapters/11-functional/*` as the only Chapter 11 track for planning, delivery, and assessment.

## Stray Files

The following files in `chapters/11-functional/` are not part of the Chapter 11 content track and should be relocated or removed:
