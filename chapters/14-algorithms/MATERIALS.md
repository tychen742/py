# Chapter 14 Materials (Algorithms)
...
1. Chapter intro stub (`1400`)
2. Algorithm concepts + Big O + benchmarking (`1401`)
3. Search implementation and reasoning (`1402`)
4. Sorting implementation and benchmarking (`1403`)
