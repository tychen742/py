# Chapter 04 Materials (Functions)
...
- Function motivation; turtle examples; defining and calling functions; parameters, arguments, defaults, `*args`, `**kwargs`, return values, and basic type annotations
