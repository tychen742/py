# Chapter 15 Organization (Algorithms)

This chapter is split into:

- `1500-intro-algorithms.ipynb` (chapter intro stub — title and chapter map only)
- `1501-algorithms.ipynb` (algorithm concepts: design, Big O, benchmarking, selection guide)
- `1502-searching.ipynb` (searching: linear, binary, bisect module, hash-based, benchmarking)
- `1503-sorting.ipynb` (sorting: built-in, insertion, bubble, merge, quick, benchmarking)

## Scope and Sequencing

Use this sequence to avoid overlap and keep pacing clear:

1. `1500-intro-algorithms.ipynb`
   - Chapter intro stub: title and chapter flow map. No exercises.
2. `1501-algorithms.ipynb`
...
- `1500-intro-algorithms.ipynb`: Chapter intro stub. No exercises.
- `1501-algorithms.ipynb`: Algorithm concepts, Big O, benchmarking, selection guide. No exercises (intro-level framing notebook).
- `1502-searching.ipynb`: coding lab + bisect module + hash-based lookup + exercises.
- `1503-sorting.ipynb`: coding lab + benchmarking + exercises.
- `MATERIALS.md`: teaching/assessment assets and prep checklist.

## Source of Truth

Use `chapters/15-algorithms/*` as the only Chapter 15 track for planning, delivery, and assessment.
