# A recursive function is the process of a function calling itself. 
#  iterative function with accumulator variable
# a base case: a conditional branch in a recursive functio ntaht does not make a recursive vall
# sample iteration (for loop) with accumulator variable

# calculate factorial iteratively (https://www.youtube.com/watch?v=Lvwy_luUjfc&ab_channel=NoureddinSadawi)
...
def factorial_recursive(x):
    ...
    result = x * factorial_recursive(x-1)   ### call the function itself
    return result
