class Stack:
    ...
    def push(self, item):
        ...
        Returns nothing.
        The runtime for this method is 0(1),
        or constant time, because appending to the
    ...
    def pop(self):
        """
        Removes and returns the last item for this list,
    ...
    def peek(self):
        """
        Returns the last item in the list, which is also
    ...
    def size(self):
        ...
        This method runs in constant time because finding the length of
        a list also in constant time.
        """
        return len(self.items)

    def is_empty(self):
        """
        Returns a Boolean value describing whether or not
        the Stack is empty.
